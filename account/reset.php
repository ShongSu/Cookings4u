		...
		<div class="contact-main">
			...
			<div class="contact-bottom">
				<div class="contact-bottom-left">
					<p>Input your email address, we will send you an email to reset your password.</p>
					<br />
					<input type="text" value="" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '';}" placeholder="Your Email Address"/>
					<br />
